...
def aeropuerto(seed = 12345, freq = 30, time = 720, c = 5, Cola_max = 35, service_time = np.array([0.5, 1, 1.5]),
    ...
    - Cola_max (int): parámetro que define número de personas crítico en cola para el cual se activan todos los servidores.
    - cmax (int): número máximo de servidores que pueden estar activos simultáneamente.
    """
...
if __name__=='__main__':
    ...
    """Función que ejecuta el programa principal y todos los métodos necesarios"""
